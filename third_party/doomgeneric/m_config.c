...
static const default_t doom_defaults_list_rom[] =
{
    //!
...
static default_t *doom_defaults_list;  // DG_TABULOUS: heap copy of doom_defaults_list_rom
static default_collection_t doom_defaults =
{
    NULL,  // DG_TABULOUS: filled by EnsureDefaults
    arrlen(doom_defaults_list_rom),
    NULL,
};

//! @begin_config_file extended

static const default_t extra_defaults_list_rom[] =
{
    //!
...
static default_t *extra_defaults_list;  // DG_TABULOUS: heap copy of extra_defaults_list_rom
static default_collection_t extra_defaults =
{
    NULL,
    arrlen(extra_defaults_list_rom),
    NULL,
};
...
// DG_TABULOUS: the variable lists are written to (bound keys, locations),
// so they cannot stay in flash, and as initialised data they took 5 KB of
// internal RAM. They are copied to the heap the first time they are needed.
static void EnsureDefaults(void)
{
    if (doom_defaults_list) return;
    doom_defaults_list = malloc(sizeof(doom_defaults_list_rom));
    memcpy(doom_defaults_list, doom_defaults_list_rom, sizeof(doom_defaults_list_rom));
    doom_defaults.defaults = doom_defaults_list;
    extra_defaults_list = malloc(sizeof(extra_defaults_list_rom));
    memcpy(extra_defaults_list, extra_defaults_list_rom, sizeof(extra_defaults_list_rom));
    extra_defaults.defaults = extra_defaults_list;
}
...
{
#ifdef DG_TABULOUS
    extern const char *DG_ConfigDir(void);
    return M_StringDuplicate(DG_ConfigDir());
#endif
