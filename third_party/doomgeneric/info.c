...
// DG_TABULOUS: the table lives in flash; a copy is made in RAM at start
// (dg_alloc_tables), because 40 KB of initialised data would otherwise sit
// in internal RAM, which the chip does not have to spare.
