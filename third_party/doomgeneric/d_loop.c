...
// DG_TABULOUS: heap (PSRAM) rather than 20 KB of static internal RAM.
static ticcmd_set_t *ticdata;
static void EnsureTicdata(void)
{
    if (!ticdata) ticdata = calloc(BACKUPTICS, sizeof(ticcmd_set_t));
}
